...
if __name__ == "__main__":
    ...
    dataset_output_path = "Output/No Normalization/Dataset.txt"
    ...
    results_file = f"Output/No Normalization/knn_results_{mode}.txt"
    calculations_file = f"Output/No Normalization/knn_calculations_{mode}.txt"
